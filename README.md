...
* Также тут будут размещаться по мере решения некоторые задачки (предварительно, я перевожу описание задачек на русский язык, чтобы мне было проще понять, что от меня требуется) с сайта [**Codewars**](https://www.codewars.com/). Многие из этих задачек, как мне кажется, довольно сложные и требуют детального пояснения.
